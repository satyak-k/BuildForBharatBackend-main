...
from .filepath import gst_certificate_path, business_profile_pic_path, product_images_path, catalogue_images_path
...
class ProductCategory(models.Model):
    ...
    created_by = models.ForeignKey(User, on_delete=models.DO_NOTHING, related_name='category_created_by', null=True)
    created_on = models.DateTimeField(auto_now_add=True)
    updated_on = models.DateTimeField(auto_now=True)
...
class Catalogue(models.Model):
    created_by = models.ForeignKey(User, on_delete=models.DO_NOTHING, related_name='catalogue_created_by', null=True)
    name = models.CharField(max_length=255)
    category = models.ForeignKey(ProductCategory, on_delete=models.DO_NOTHING, related_name='catalogue_category')
    is_verified = models.BooleanField(default=False)
    remark = models.TextField(null=True, blank=True, help_text='Give Remark (Optional)')
    created_on = models.DateTimeField(auto_now_add=True)
    updated_on = models.DateTimeField(auto_now=True)
...
class Manufacturer(models.Model):
    ...
    is_verified = models.BooleanField(default=False)
    catalogue = models.ManyToManyField(Catalogue, blank=True, related_name='manufacturer_catalogue')
    remark = models.TextField(null=True, blank=True, help_text='Give Remark (Optional)')
    created_on = models.DateTimeField(auto_now_add=True)
    updated_on = models.DateTimeField(auto_now=True)
...
class Product(models.Model):
    ...
    catalogue = models.ForeignKey(Catalogue, on_delete=models.DO_NOTHING, related_name='product_catalogue')
    category = models.ForeignKey(ProductCategory, on_delete=models.CASCADE, related_name='product_category')
    is_active = models.BooleanField(default=True)
    message = models.TextField(null=True, blank=True, help_text='Helping message (Optional)')
    created_on = models.DateTimeField(auto_now_add=True)
    updated_on = models.DateTimeField(auto_now=True)
    ...
    class Meta:
        verbose_name = "Product Templates"


class ProductDetails(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='product_details_user')
    product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name='product_details_product')
    discount = models.IntegerField(default=0)
    final_price = models.CharField(max_length=250, null=True, blank=True)
    ...
    class Meta:
        verbose_name = "Seller mapped products"
...
class Business(models.Model):
    ...
    products = models.ManyToManyField(ProductDetails, related_name='business_products')
...
class ProductImages(models.Model):
    user = models.ForeignKey(User, on_delete=models.DO_NOTHING, related_name='product_images_user')
    image = models.ImageField(upload_to=product_images_path, help_text='Upload file for product Images.')
...
class CatalogueImages(models.Model):
    user = models.ForeignKey(User, on_delete=models.DO_NOTHING, related_name='catalogue_images_user')
    file = models.ImageField(upload_to=catalogue_images_path, help_text='Upload file for catalogue Images.')
    added_on = models.DateTimeField(auto_now_add=True)
    updated_on = models.DateTimeField(auto_now=True)
